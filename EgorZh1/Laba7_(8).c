...
int main()
{
    FILE* f = fopen("C:/Users/Asus/source/repos/Laba7_(8)/GoodsBase.txt", "a+");
    if (f == NULL)
    {
        cout << "Error";
        _getch();
    ...
    if (answer == 1)
    {
        while (1)
        {
            FILE* fin = fopen("C:/Users/Asus/source/repos/Laba7_(8)/DiscountCards.txt", "a+");
            if (fin == NULL)
            {
                cout << "Error";
                _getch();
    ...
    FILE* fn = fopen("C:/Users/Asus/source/repos/Laba7_(8)/HistoryOfPurchases.txt", "a");
    if (fn == NULL)
    {
        cout << "Error";
        _getch();
