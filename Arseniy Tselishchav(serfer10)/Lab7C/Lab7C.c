...
//BelAvia. Компания работает по заданному годовому расписанию:
//номер рейса, тип самолета, маршрут, промежуточные пункты,
//время отправления, дни полета.Поиск по всем полям.Выбор
//ближайшего рейса до заданного пункта.Функции заказа билетов на
//рейс и возврата билетов.Количество свободных мест на каждом
//рейсе.Оформление посадочной ведомости, печать билетов.
